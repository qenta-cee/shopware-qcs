...
abstract class QentaCEE_Stdlib_Return_ReturnAbstract
{
     ...
     * Validators holder
     *
     * @var QentaCEE_Stdlib_Validate_ValidateAbstract[]
     * @internal
     */
     ...
     * Adds the validator
     *
     * @param QentaCEE_Stdlib_Validate_ValidateAbstract $oValidator
     * @param string $param
     *
     * @return QentaCEE_Stdlib_Return_ReturnAbstract
     */
    public function addValidator(QentaCEE_Stdlib_Validate_ValidateAbstract $oValidator, $param)
    {
